...
public class SerieMapper {
    ...
    public SerieCompleteDTO convertToCompleteDTO(Serie serie, UUID userId) {
        ...
        dto.setPosterURL1(serie.getPosterURL1());
        dto.setPosterURL2(serie.getPosterURL2());
        dto.setBackdropURL1(serie.getBackdropURL1());
        dto.setBackdropURL2(serie.getBackdropURL2());
        dto.setBackdropURL3(serie.getBackdropURL3());
        dto.setBackdropURL4(serie.getBackdropURL4());
        dto.setLogoURL1(serie.getLogoURL1());
        dto.setLogoURL2(serie.getLogoURL2());
        dto.setTotalTemporadas(serie.getTotalTemporadas());
        dto.setTotalEpisodios(serie.getTotalEpisodios());
        dto.setTotalLikes((long) (serie.getLikes() != null ? serie.getLikes().size() : 0));
